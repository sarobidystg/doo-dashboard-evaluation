...
const InputGroup: React.FC<InputGroupProps> = ({
  ...
  return (
    <div className={className}>
      ...
      >
        {label}
        {required && <span className="ml-1 select-none text-error-500">*</span>}
      </label>
      ...
      >
        <input
          ...
          className={cn(
            "w-full rounded-lg border-[1.5px] border-gray-200 bg-transparent outline-none transition focus:border-primary-500 disabled:cursor-default disabled:bg-gray-100 data-[active=true]:border-primary-500 dark:border-gray-700 dark:bg-gray-800 dark:focus:border-primary-500 dark:disabled:bg-gray-900 dark:data-[active=true]:border-primary-500",
            type === "file"
